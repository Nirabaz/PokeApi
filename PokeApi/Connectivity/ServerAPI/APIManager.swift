...
class SELAPIManager {
    ...
    private static var sharedNetworkManager: SELAPIManager = {
        return SELAPIManager()
    }()
    ...
    class func shared() -> SELAPIManager {
    ...
    func removeListingItem(itemId: Int, success: @escaping api_success_block) {
